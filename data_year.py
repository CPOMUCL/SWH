...
#                 day_of_year = (self.dates[tt] - dt.datetime(self.dates[tt].year,1,1)).days + 1
    ...
    def mean_series(self,periods=[],mask = False,year_set = [],time_set = [],method='mean',mult_array=False):
        """
...
#             for mn in range(self.periods):
    ...
    def clim_map(self,periods=[],mask = False,year_set = [],year_select=None,time_set = [],method = 'mean',calc_mask = False):
        """
        This is the money method, cash in on making the effort to organise your yearly gridded data correcty.
        We can select the years and periods of interest and get back a map of that data. The method for collecting this data can be mean, median, std and sum.
    ...
    def centile_map(self,centile,periods=[],mask = False,year_set = [],year_select=None,time_set = [],calc_mask = False):
        """
        This is the money method, cash in on making the effort to organise your yearly gridded data correcty.
...
#             print(idx)
    ...
    def save_nc(self,filename,d0,data_attr, tdim='days',save_mask = False,mask=False,
